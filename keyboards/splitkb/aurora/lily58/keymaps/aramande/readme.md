...
Compile and flash the hex file
--------------------
Make sure to set keyboard and keymap in qmk settings, 
otherwise append `-kb splitkb/aurora/lily58/ -km aramande` to qmk commands
**Steps for Elite-C**:
```bash
qmk compile
qmk flash
...
**Steps for Pro Micro**:
```bash
make splitkb/aurora/lily58:aramande:avrdude
```

For building guide see: https://docs.qmk.fm/#/newbs_building_firmware?id=create-a-new-keymap
